...
import * as ɵngcc6 from 'ngx-color/chrome';
let nextUniqueId = 0;
...
MtxColorPickerComponent.ɵfac = function MtxColorPickerComponent_Factory(t) { return new (t || MtxColorPickerComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.FocusMonitor), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.NgControl, 10), ɵngcc0.ɵɵdirectiveInject(ɵngcc3.MatFormField, 9), ɵngcc0.ɵɵdirectiveInject(DOCUMENT, 8)); };
MtxColorPickerComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: MtxColorPickerComponent, selectors: [["mtx-color-picker"]], viewQuery: function MtxColorPickerComponent_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵstaticViewQuery(MatMenuTrigger, true);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.trigger = _t.first);
    } }, inputs: { value: "value", id: "id", placeholder: "placeholder", required: "required", disabled: "disabled" }, outputs: { colorChange: "colorChange" }, exportAs: ["mtxColorPicker"], features: [ɵngcc0.ɵɵProvidersFeature([{ provide: MatFormFieldControl, useExisting: MtxColorPickerComponent }])], decls: 7, vars: 6, consts: [["matInput", "", "autocomplete", "off", 3, "ngModel", "placeholder", "disabled", "ngModelChange", "focus"], [3, "matMenuTriggerFor", "menuOpened", "menuClosed"], ["colorPickerTrigger", "matMenuTrigger"], [1, "mtx-color-picker-panel", 3, "hasBackdrop"], ["colorPickerPopover", "matMenu"], [1, "mtx-color-picker", 3, "click", "keydown"], [3, "color", "onChangeComplete"]], template: function MtxColorPickerComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelementStart(0, "input", 0);
        ɵngcc0.ɵɵlistener("ngModelChange", function MtxColorPickerComponent_Template_input_ngModelChange_0_listener($event) { return ctx.value = $event; })("focus", function MtxColorPickerComponent_Template_input_focus_0_listener() { return ctx._handleFocus(); });
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵelementStart(1, "div", 1, 2);
        ɵngcc0.ɵɵlistener("menuOpened", function MtxColorPickerComponent_Template_div_menuOpened_1_listener() { return ctx._openPanel(); })("menuClosed", function MtxColorPickerComponent_Template_div_menuClosed_1_listener() { return ctx._closePanel(); });
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵelementStart(3, "mat-menu", 3, 4);
        ɵngcc0.ɵɵelementStart(5, "div", 5);
        ɵngcc0.ɵɵlistener("click", function MtxColorPickerComponent_Template_div_click_5_listener($event) { return $event.stopPropagation(); })("keydown", function MtxColorPickerComponent_Template_div_keydown_5_listener($event) { return $event.stopPropagation(); });
        ɵngcc0.ɵɵelementStart(6, "color-chrome", 6);
        ɵngcc0.ɵɵlistener("onChangeComplete", function MtxColorPickerComponent_Template_color_chrome_onChangeComplete_6_listener($event) { return ctx._onColorChanged($event); });
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵelementEnd();
    } if (rf & 2) {
        const _r1 = ɵngcc0.ɵɵreference(4);
        ɵngcc0.ɵɵproperty("ngModel", ctx.value)("placeholder", ctx.placeholder)("disabled", ctx.disabled);
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("matMenuTriggerFor", _r1);
        ɵngcc0.ɵɵadvance(2);
        ɵngcc0.ɵɵproperty("hasBackdrop", false);
        ɵngcc0.ɵɵadvance(3);
        ɵngcc0.ɵɵproperty("color", ctx.value);
    } }, directives: [ɵngcc4.MatInput, ɵngcc2.DefaultValueAccessor, ɵngcc2.NgControlStatus, ɵngcc2.NgModel, ɵngcc5.MatMenuTrigger, ɵngcc5._MatMenu, ɵngcc6.ChromeComponent], styles: [".mtx-color-picker-panel .mat-menu-content:not(:empty){padding:0}.mtx-color-picker-panel .mtx-color-picker{padding:8px}.mtx-color-picker-panel .mtx-color-picker .chrome-picker{box-shadow:none;border-radius:0}.mtx-color-picker-panel .mtx-color-picker .chrome-picker .saturation{border-radius:0}"], encapsulation: 2, changeDetection: 0 });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(MtxColorPickerComponent, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: ɵngcc1.FocusMonitor }, { type: ɵngcc0.ElementRef }, { type: ɵngcc0.ChangeDetectorRef }, { type: ɵngcc0.NgZone }, { type: ɵngcc2.NgControl, decorators: [{
                type: Optional
            }, {
                type: Self
...
MtxColorPickerModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: MtxColorPickerModule });
MtxColorPickerModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function MtxColorPickerModule_Factory(t) { return new (t || MtxColorPickerModule)(); }, imports: [[
            CommonModule,
            FormsModule,
            MatMenuModule,
            MatFormFieldModule,
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(MtxColorPickerModule, { declarations: function () { return [MtxColorPickerComponent]; }, imports: function () { return [CommonModule,
        FormsModule,
        MatMenuModule,
        MatFormFieldModule,
        MatInputModule,
        ColorChromeModule]; }, exports: function () { return [MtxColorPickerComponent]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(MtxColorPickerModule, [{
        type: NgModule,
        args: [{
                imports: [
                    CommonModule,
